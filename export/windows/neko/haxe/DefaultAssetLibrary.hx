...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/data/sample-large-map.csv", "assets/data/sample-large-map.csv");
		type.set ("assets/data/sample-large-map.csv", AssetType.TEXT);
		path.set ("assets/images/backgrounds/background1.png", "assets/images/backgrounds/background1.png");
		type.set ("assets/images/backgrounds/background1.png", AssetType.IMAGE);
		path.set ("assets/images/backgrounds/background2.png", "assets/images/backgrounds/background2.png");
		type.set ("assets/images/backgrounds/background2.png", AssetType.IMAGE);
		path.set ("assets/images/backgrounds/background3.png", "assets/images/backgrounds/background3.png");
		type.set ("assets/images/backgrounds/background3.png", AssetType.IMAGE);
		path.set ("assets/images/backgrounds/background4.png", "assets/images/backgrounds/background4.png");
		type.set ("assets/images/backgrounds/background4.png", AssetType.IMAGE);
		path.set ("assets/images/backgrounds/background5.png", "assets/images/backgrounds/background5.png");
		type.set ("assets/images/backgrounds/background5.png", AssetType.IMAGE);
		path.set ("assets/images/images-go-here.txt", "assets/images/images-go-here.txt");
		type.set ("assets/images/images-go-here.txt", AssetType.TEXT);
		path.set ("assets/images/tilesets/tileset1.png", "assets/images/tilesets/tileset1.png");
		type.set ("assets/images/tilesets/tileset1.png", AssetType.IMAGE);
		path.set ("assets/images/tilesets/tileset2.png", "assets/images/tilesets/tileset2.png");
		type.set ("assets/images/tilesets/tileset2.png", AssetType.IMAGE);
		...
		id = "assets/data/sample-large-map.csv";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/backgrounds/background1.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/backgrounds/background2.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/backgrounds/background3.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/backgrounds/background4.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/backgrounds/background5.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/images-go-here.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/tilesets/tileset1.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tilesets/tileset2.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
