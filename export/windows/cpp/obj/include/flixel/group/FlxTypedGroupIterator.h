...
HX_DECLARE_STACK_FRAME(_hx_pos_a2c5aad29e94c731_834_new)
...
HXLINE( 835)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_groupMembers = GroupMembers;
HXLINE( 836)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_filter = filter;
HXLINE( 837)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_cursor = (int)0;
HXLINE( 838)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_length = ( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_groupMembers->get_length();
            	}
